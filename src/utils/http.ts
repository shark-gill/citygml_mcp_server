 ...
 * @returns 요청 결과
 */
export async function fetchDocument(url: string, options?: AxiosRequestConfig): Promise<string> {
  let retries = 0;
 ...
 * @returns 요청 결과 배열
 */
export async function fetchMultipleDocuments(urls: string[], options?: AxiosRequestConfig): Promise<string[]> {
